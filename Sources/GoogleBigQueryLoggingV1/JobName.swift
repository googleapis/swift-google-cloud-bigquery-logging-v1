...
public struct JobName: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The project ID.
  ...
  /// Initialize a new instance of `JobName`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = JobName().with { $0.projectId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.logging.v1.JobName"
  }
