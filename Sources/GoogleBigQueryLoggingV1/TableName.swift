...
public struct TableName: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  /// The project ID.
  ...
  /// Initialize a new instance of `TableName`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TableName().with { $0.projectId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.logging.v1.TableName"
  }
